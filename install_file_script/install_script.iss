...
#define MyAppExeName "IP Switcher 5.0.2.exe"
#define MyAppBuildDir "IP Switcher 5.0.2"
...
[Files]
Source: "..\src\dist\{#MyAppBuildDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Type: files; Name: "{app}\IP Switcher 4.4.1.exe"
...
Type: files; Name: "{app}\IP Switcher 5.0.1.exe"
