...
The build outputs a one-folder app at `src/dist/IP Switcher 4.5.1/`. The executable requests administrator privileges because changing interface IP settings requires elevation on Windows.
