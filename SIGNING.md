...
```powershell
signtool sign /fd SHA256 /tr http://timestamp.digicert.com /td SHA256 /a "src\dist\IP Switcher 5.0.0\IP Switcher 5.0.0.exe"
signtool sign /fd SHA256 /tr http://timestamp.digicert.com /td SHA256 /a "install_file_script\installer_files\IP Switcher-5.0.0-Installer-x64.exe"
```

If you have a specific certificate thumbprint:

```powershell
signtool sign /fd SHA256 /tr http://timestamp.digicert.com /td SHA256 /sha1 YOUR_CERT_THUMBPRINT "src\dist\IP Switcher 5.0.0\IP Switcher 5.0.0.exe"
```
